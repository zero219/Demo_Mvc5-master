...
namespace Remote.Interface
{
    public interface ISearch
    {
        ...
        PageResults<CommodityModel> QueryCommodityPage(int pageIndex, int pageSize, string keyword, List<int> categoryIdList, string priceFilter, string priceOrderBy);
    }
}
